...
import javax.swing.border.EmptyBorder;import jdbc.controller.UsuariosController;
	...
	public Login() {
		...
		txtUsuario.addKeyListener(new KeyAdapter() {
		    ...
		    public void keyPressed(KeyEvent e) {
		        String usuarioPlaceholder = "Ingrese su nombre de usuario";
		        String contrasenaPlaceholder = "********";
		        
		        if (txtUsuario.getText().equals(usuarioPlaceholder)) {
		            txtUsuario.setText("");
		            txtUsuario.setForeground(Color.black);
		        }
		        
		        if (String.valueOf(txtContrasena.getPassword()).equals(contrasenaPlaceholder)) {
		...
		txtContrasena.addKeyListener(new KeyAdapter() {
		    ...
		    public void keyPressed(KeyEvent e) {
		        ...
		        if (String.valueOf(txtUsuario.getText()).equals(usuarioPlaceholder)) {
		            txtUsuario.setText("");
		            txtUsuario.setForeground(Color.black);
		        }
