...
public class RegistroHuesped extends JFrame {
	...
	public RegistroHuesped(int idReserva) {
		...
		txtNacionalidad.setBounds(560, 350, 189, 36);
		txtNacionalidad.setBackground(SystemColor.text);
		txtNacionalidad.setFont(new Font("Roboto", Font.PLAIN, 16));
		txtNacionalidad.setModel(new DefaultComboBoxModel(new String[] {"afgano(a)", "alemán(a)", "árabe", "argentino(a)", "australiano(a)", "belga",
				"boliviano(a)", "brasileño(a)", "camboyano(a)", "canadiense", "chileno(a)", "chino(a)", "colombiano(a)", "coreano(a)", "costarricense",
				"cubano(a)", "danés(a)", "dominicano(a)", "ecuatoriano(a)", "egipcio(a)", "escocés(a)", "español(a)", "estadounidense", "estonio(a)", "etiope",
				"filipino(a)", "finlandés(a)", "francés(a)", "galés(a)", "griego(a)", "guatemalteco(a)", "haitiano(a)", "holandés(a)", "hondureño(a)", "indonés(a)",
				"inglés(a)", "iraquí", "iraní", "irlandés(a)", "israelí", "italiano(a)", "japonés(a)", "jordano(a)", "laosiano", "letón(a)", "malayo(a)", "marroquí",
				"mexicano(a)", "nicaragüense", "noruego(a)", "neozelandés(a)", "panameño(a)", "paraguayo(a)", "peruano(a)", "polaco(a)", "portugués(a)", "puertorriqueño(a)",
				"rumano(a)", "ruso(a)","salvadoreño(a)", "sueco(a)", "suizo(a)", "tailandés(a)", "taiwanes(a)", "turco(a)", "ucraniano(a)", "uruguayo(a)", "venezolano(a)", "vietnamita"}));
		...
		((AbstractDocument) txtNombre.getDocument()).setDocumentFilter(new DocumentFilter() {
		    ...
		    public void replace(FilterBypass fb, int offset, int length, String text, AttributeSet attrs) throws BadLocationException {
		        if (containsOnlyCharacters(text)) {
		            super.replace(fb, offset, length, text, attrs);
		        }
		    }

		    private boolean containsOnlyCharacters(String text) {
		        return text.matches("[a-zA-ZñÑ\\s]*");
		    }
		});

		// Agregar DocumentFilter a txtApellido para aceptar solo caracteres
		((AbstractDocument) txtApellido.getDocument()).setDocumentFilter(new DocumentFilter() {
		    @Override
		    public void insertString(FilterBypass fb, int offset, String string, AttributeSet attr) throws BadLocationException {
		        if (containsOnlyCharacters(string)) {
		            super.insertString(fb, offset, string, attr);
		...
		// Agregar el DocumentFilter al JTextField para aceptar solo números
